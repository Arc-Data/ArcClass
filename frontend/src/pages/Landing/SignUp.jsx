            ...
            <div className={`${formStep === 0 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-full'} transition-opacity duration-300 transform`}>
                {formStep === 0 && (
                    <div className="px-6 py-4 space-y-4"> 
                        ...
                        <p className="mt-8">Already have an account? <span><Link to="/signin" className="text-primary">Login</Link></span></p>
                        </div>
                )}
            </div>
            ...
            <div className={`${formStep === 1 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-full'} transition-opacity duration-300 transform`}>
                {formStep === 1 && (
                    <form action={submitAction} className="px-6 py-4 space-y-4">
                        ...
                        :
                        <button type="submit" disabled={loading} className="w-full text-white bg-primary-500 hover:bg-primary-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2  focus:outline-hidden">Register</button>
                        }
                        <p>Already have an account? <span><Link to="/signin" className="text-primary">Login</Link></span></p>
                    </form>
                )}
            </div>
        </div>
